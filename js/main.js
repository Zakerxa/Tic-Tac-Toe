...
$(document).ready(function() {
    ...
    createApp({
        ...
        methods: {
            ...
            disabledBtn() {
                this.cover = true;
                setTimeout(() => this.cover = false, 600);
            },
            cleardata() {
                ...
                this.winstyle.animation1 = '', this.winstyle.animation2 = '', this.winstyle.animation3 = '', this.winstyle.animation4 = '', this.winstyle.animation5 = '', this.winstyle.animation6 = '', this.winstyle.animation7 = '', this.winstyle.animation8 = '', this.winstyle.animation9 = '';
            },
            ...
            winAnimation(e) {
                switch (e) {
                    case 123:
                        this.winstyle.animation1 = this.wsp;
                        this.winstyle.animation2 = this.wsp;
                        this.winstyle.animation3 = this.wsp;
                        break;
                    case 456:
                        this.winstyle.animation4 = this.wsp;
                        this.winstyle.animation5 = this.wsp;
                        this.winstyle.animation6 = this.wsp;
                        break;
                    case 789:
                        this.winstyle.animation7 = this.wsp;
                        this.winstyle.animation8 = this.wsp;
                        this.winstyle.animation9 = this.wsp;
                        break;
                    case 147:
                        this.winstyle.animation1 = this.wsp;
                        this.winstyle.animation4 = this.wsp;
            ...
            restartGame(e) {
                this.d1 = true, this.d2 = true, this.d3 = true, this.d4 = true, this.d5 = true, this.d6 = true, this.d7 = true, this.d8 = true, this.d9 = true;
                setTimeout(() => {
                    if (e == "win") this.winms.play();
                    else if (e == "lose") this.losems.play();
                    else if (e == "draw") this.drawms.play();
                    fetch("").then(() => $('#gamefinalresult').modal('show'));
                    this.cleardata();
                }, 1500);

                setTimeout(() => {
                    fetch("").then(() => $('#gamefinalresult').modal('hide'));
                    this.wintrue = false;
                }, 2500);
        ...
        mounted() {
            ...
            this.winms = new Audio("./sound/win.wav")
            this.losems = new Audio("./sound/lose.wav");
            this.tapms = new Audio("./sound/tap.mp3");
            this.drawms = new Audio("./sound/draw.wav");
            this.allthree = new Audio("./sound/allthree.wav");

            fetch("").then(() => $('#selectplayer').modal('show'));
        },
        computed: {
